...
class AccountManager {
    ...
    static createInitialAccountManager(server) {
        // Load player information
        let player1Mage = server.worlds[0].createInstance("player_mage", 1);
        ...
        let player1Warrior = server.worlds[0].createInstance("player_warrior", 1);
        ...
        let player2Mage = server.worlds[0].createInstance("player_mage", 1);
        ...
        let player2Warrior = server.worlds[0].createInstance("player_warrior", 1);
